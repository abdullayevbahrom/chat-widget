                            ...
                            <tr class="hover:bg-brand-50/30 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <button x-data
                                                @click="$dispatch('open-delete-modal', { id: {{ $project->id }}, name: '{{ addslashes($project->name) }}' })"
...
<div x-data="{
     ...
     @open-delete-modal.window="open = true; projectId = $event.detail.id; projectName = $event.detail.name; deleteUrl = '/dashboard/projects/' + $event.detail.id"
     x-cloak
     x-show="open"
    ...
    <div x-show="open"
        ...
        <p class="text-gray-600 mb-6">
            Are you sure you want to delete <span class="font-semibold text-gray-900" x-text="projectName"></span>?
            All associated data, including conversations and widget keys, will be permanently removed.
        </p>
